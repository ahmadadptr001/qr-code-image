import image from "../assets/Desain tanpa judul (6).png"

export default function CardImage6 () {
        return (
                <div className="p-5 flex justify-center bg-gray-700 text-white">
                        <div id="card" className="border border-gray-300 rounded-md w-[300px]">
                                ...
                                <div className="card-body p-3">
                                        ...
                                        <p className="mt-3">Nama: Richsweet Dessert</p>
                                        <p className="">Harga: Rp 14.000,00</p>
                                </div>
                        </div>
                </div>
        )
