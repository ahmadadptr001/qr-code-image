import image from "../assets/Desain tanpa judul (18).png"

export default function CardImage18 () {
        return (
                <div className="p-5 flex justify-center bg-gray-700 text-white">
                        <div id="card" className="border border-gray-300 rounded-md w-[300px]">
                                ...
                                <div className="card-body p-3">
                                        ...
                                        <p className="mt-3">Nama: Es Teh Segar</p>
                                        <p className="">Harga: Rp 12.000,00</p>
                                </div>
                        </div>
                </div>
        )
